...
from pages_new.Forecast_data_new import process_day_data_downloaded_maharajgunj
from pages_new.Forecast_data_new import process_day_data_downloaded_phora
...
for i, col in enumerate([col1, col2, col3, col4, col5, col6, col7], start = 1):
    ...
    if col.button(f"{date_label3}", use_container_width=True, key =f"Maharajgunj_Day{i}" ):
        ...
        dataframes = process_day_data_downloaded_maharajgunj(i, algorithms, unique_date_lable1)
...
for i, colp in enumerate([col1p, col2p, col3p, col4p, col5p, col6p, col7p], start = 1):
    ...
    if colp.button(f"{date_label4}", use_container_width=True, key = f"Daysss{i}"):
        ...
        dataframes_p = process_day_data_downloaded_phora(i, algorithms, unique_date_lable1)
